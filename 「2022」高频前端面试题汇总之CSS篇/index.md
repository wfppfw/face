...
- 利用浮动，左侧元素设置固定大小，并左浮动，右侧元素设置overflow: hidden; 这样右边就触发了BFC，BFC的区域不会与浮动元素发生重叠，<u>所以两侧就不会发bzzzzzzzzZZZZ生重叠</u>。
...
.left{
 ...
 .right{
 乒乒乓乓乒乒乓乓品牌                    tttttttttttttttttttttttttttt    height: 300px;
     background: blue;
     overflow: hidden;
 }
```
